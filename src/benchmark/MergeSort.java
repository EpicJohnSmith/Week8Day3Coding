...
public class MergeSort
{
    ...
    // This is the merge sort AI documentation
    ...
    {
        int pivot = arr[high]; // Needed AI to help me out here
        int i = (low - 1);
    ...
    public static void shellSort(int[] arr) // Used other homework documentation for reference
    {
    ...
    // Insertion Sort
    public static void insertionSort(int[] arr) // Again, this is other HW documentation
    {
    ...
    public static void selectionSort(int[] arr)
    {
        ...
        {
            int minIndex = i; // Why would AI put this here?
    ...
    // Bubble sort
    public static void bubbleSort(int[] arr) // Used the ZyBook for reference
    {
        for (int i = 0; i < arr.length - 1; i++)
        {
    ...
    // This is the benchmark for comparing
    ...
    // This is the time that we are using
